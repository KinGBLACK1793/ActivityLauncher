package de.szalkowski.activitylauncher.rustore_fork.ui.adapter;
...
import de.szalkowski.activitylauncher.rustore_fork.databinding.AllActivitiesChildItemBinding;
import de.szalkowski.activitylauncher.rustore_fork.databinding.AllActivitiesGroupItemBinding;
...
public class AllTasksListAdapter extends BaseExpandableListAdapter implements Filterable {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        binding.textViewPackageVersion.setText(pack.getVersion());
